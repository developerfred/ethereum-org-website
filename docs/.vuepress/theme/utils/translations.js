...
const translations = {
  'en-US': {
    ...
    'page-home-section-use-item-one-link': '/use/#_1-use-an-application-built-on-ethereum', // TODO remove for all langs
    'page-home-section-use-item-two': 'How do I get Ether?', // TODO remove for all langs
    'page-home-section-use-item-two-link': '/use/#_2-what-is-eth-and-how-do-i-get-it', // TODO remove for all langs
